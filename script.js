document.addEventListener('DOMContentLoaded', () => {
  ...
  function protectPage() {
    ...
    // If logged in, check if they are on the correct dashboard
    if (loggedInUser.userType === 'chef' && currentPage !== 'chef-dashboard.html') {
      if (currentPage === 'owner-dashboard.html') window.location.href = 'chef-dashboard.html';
    } else if (loggedInUser.userType === 'owner' && currentPage !== 'owner-dashboard.html') {
      if (currentPage === 'chef-dashboard.html') window.location.href = 'owner-dashboard.html';
    }
    // Allow access if on the correct dashboard or other non-protected pages
  }
  ...
  function handleLogout() {
    clearLoggedInUser();
    updateAuthUI(); // Update header immediately
  ...
  updateAuthUI(); // Call on every page load for header
  ...
  } else if (currentPage === 'chef-dashboard.html' || currentPage === 'owner-dashboard.html') {
